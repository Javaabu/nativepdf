...
[discussions](https://github.com/Javaabu/nativepdf/issues). You may also 
seek help on
...
[GitHub issue tracker](http://github.com/Javaabu/nativepdf/issues). Before 
...
[discussions](https://github.com/Javaabu/nativepdf/issues) instead.

### Reporting bugs effectively

- nativepdf is maintained by volunteers. They don't owe you anything, so be
...
- Mention which release of nativepdf you're using (the zip, a specific branch, etc).
...
- If the problem can not be reproduced in any of the demos included in the
  nativepdf distribution, please provide an HTML document that demonstrates
...
- Fork [nativepdf](https://github.com/Javaabu/nativepdf/)
