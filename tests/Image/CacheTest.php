...
class CacheTest extends TestCase
{
    ...
    {
        return [
            ["../_files/jamaica.jpg", "file://" . realpath(__DIR__ . "/../_files/jamaica.jpg"), -1],
            ["../_files/square.svg", "file://" . realpath(__DIR__ . "/../_files/square.svg"), -1],
            ...
            ["../_files/bad.bmp", Image\Cache::$broken_image, "50M"]
        ];
    }
    ...
    public function testUrlResolution(string $url, string $expected, $maxsize): void
    {
        $protocol = "";
        $host = "";
        $base_path = __DIR__;
